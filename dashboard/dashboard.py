...
days_df = pd.read_csv("C:/Users/acer/ProyekAnalisisData/dashboard/day_clean.csv")
hours_df = pd.read_csv("C:/Users/acer/ProyekAnalisisData/dashboard/hour_clean.csv")
...
st.subheader("Pada jam berapa penyewaan sepeda paling banyak dilakukaan & paling sedikit dilakukan?")
